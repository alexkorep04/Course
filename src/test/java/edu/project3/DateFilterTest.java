...
public class DateFilterTest {
    ...
    public void testFittingDate() {
        Log log =
            new Log(null, null, OffsetDateTime.of(LocalDate.now().atStartOfDay(), ZoneOffset.UTC), null, null, null);
    ...
    public void testNotFittingDate() {
        Log log = new Log(null,
            null,
            OffsetDateTime.of(LocalDate.of(2010, 1, 1).atStartOfDay(), ZoneOffset.UTC),
            null,
            null,
            null
        );
