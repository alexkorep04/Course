...
public class Task7Test {
    ...
    @Test
    @DisplayName("Test how the k old animal is taking")
    public void testTheKOldAnimal() {
        List<Animal> animals = List.of(new Animal("Rich", Type.CAT, Sex.M, 12, 40, 6,false)
            , new Animal("Tuzik", Type.DOG, Sex.M, 7, 60, 20,true)
            , new Animal("Kuzya", Type.BIRD, Sex.M, 3, 30, 2,false)
        ...
        Animal expected = new Animal("Vanesa", Type.BIRD, Sex.F, 4, 20, 1,true);

        Animal response = task.getKHeaviestAnimal(animals, 3);
